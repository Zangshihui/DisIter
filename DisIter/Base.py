import h5py
import numpy as np
from DisIter import readgadget, readfof
...
class Base(object):
    def __init__(self, BoxSize = 1000, NMesh = 512, Omega_m0 = 0.3175, Hubble0 = 67.11, redshift = 0, *args, **kwargs):
        ...
        self.ParameterSet()
        print('Cosmology: BoxSize is %d; NMesh is %d; Omega_m0 is %f; Hubble0 is %f; redshift is %f'%(BoxSize, NMesh, Omega_m0, Hubble0, redshift))
    ...
    def RSD(self, los = 2):
        ...
        xs = x + dot(v, xhat)/H
        """
        print('Operating RSD, line-of-sight is %d'%los)
        self.Position[:, los] += (self.Hubble0/100)*self.Velocity[:, los]/((1/(self.redshift + 1)) * self.Hubble)
